...
const services = [
  {
  title: "DPF Solutions",
  desc: "Expert diagnosis, cleaning, and repair to restore DPF performance and reduce emissions.",
  image: "/carpaint.avif",
  path: "/services/mechanical",
},
{
  title: "ECU Remapping",
  desc: "Optimised engine tuning to improve power, torque, and fuel efficiency safely.",
  image: "/gray.avif",
  path: "/services/service",
},
{
  title: "Gearbox Tuning",
  desc: "Precision tuning for smoother gear changes, improved performance, and reliability.",
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[65%] mt-5 mx-auto h-75 object-cover"
                    onError={(e) => {
